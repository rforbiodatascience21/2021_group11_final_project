...
## Violin plots
```{r, out.width='90%'}
knitr::include_graphics('/cloud/project/results/pHandTemp_violinplot.png')
```

## Correlations of meta data
```{r, out.width='90%'}
knitr::include_graphics('/cloud/project/results/correlation_attributest.png')
```

## Heatmap with hierarchical clustering
```{r, out.width='100%'}
knitr::include_graphics('/cloud/project/results/heatmap_with_dendrogram.png')
```

## Heatmap with total bar
```{r, out.width='100%'}
knitr::include_graphics('/cloud/project/results/heatmap_with_totalbar.png')
```

## PCA 
```{r, out.width='100%'}
knitr::include_graphics('/cloud/project/results/pca_plot.png')
```

---

```{r, out.width='100%'}
knitr::include_graphics('/cloud/project/results/pca_variance_plot.png')
```
...
```{r, out.width='90%'}
knitr::include_graphics('/cloud/project/results/correlation_bacteria.png')
```
...
```{r, out.width='90%'}
knitr::include_graphics('/cloud/project/results/correlation_attributes_bacteria.png')
```
...
```{r, out.width='90%'}
knitr::include_graphics('/cloud/project/results/bacilli_pH_barplot.png')
```
