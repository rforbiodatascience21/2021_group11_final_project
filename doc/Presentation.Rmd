...
```{r, out.width='100%'}
knitr::include_graphics(
  path = '/cloud/project/results/taxa_boxplots.png')
```
...
## Distributions of Environmental Features for Bacteria Where OTU Count Differ Significantly Between Countries
```{r, out.width='90%'}
knitr::include_graphics(
