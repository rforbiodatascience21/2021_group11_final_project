...
pca_plot <- ggplot(pca, aes(x=.fittedPC1, y=.fittedPC2,color = site)) + 
  geom_point(size = 1.3) + 
  coord_equal() + 
...
# Write data --------------------------------------------------------------
ggsave(file ="/cloud/project/results/pca_plot.png", plot = pca_plot)
ggsave(file ="/cloud/project/results/pca_variance_plot.png", plot = pca_variance_plot)
